...
const pedidoA = new Pedido(
  "PED-101",
  [
    { nome: "Mouse Gamer", preco: 150.0, quantidade: 1 },
    { nome: "Teclado Mecânico", preco: 350.0, quantidade: 1 },
  ],
  "cliente@email.com",
);
const pedidoB = new Pedido(
  "PED-102",
  [{ nome: "Caneta Personalizada", preco: 10.0, quantidade: 10 }],
  "+5554999998888",
);
