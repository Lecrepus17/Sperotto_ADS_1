...
## Exemplo de Uso (src/index.ts)

```typescript
import { Email, Product, SMS } from "./observer"

const email = new Email("user@example.com");
const sms = new SMS("(66) 93214-5620");
const product = new Product("560", "Produto Exemplo");
product.subscribe(email);
product.subscribe(sms);
